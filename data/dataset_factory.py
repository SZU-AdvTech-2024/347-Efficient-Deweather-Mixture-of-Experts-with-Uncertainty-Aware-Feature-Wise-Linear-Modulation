...
from .dataset import AllWeather, LowLevel_Cityscapes, Raindrop, Snow100K, Synthetic_Rain, Outdoor_Rain, OTS, RVSD
...
def create_dataset(augment_enable: bool = False, task_name: str = '', ds_name: str = '', 
    ...
    if 'allweather' in ds_name:
        ...
        dataset = RVSD(dataset_root, 'desnow', split, transforms, random_crop_ratio)
    else:
        dataset = None
